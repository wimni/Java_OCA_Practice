...
public class Aufgabenstellung
{
    ...
    // }
    /*
     * Add the Interface to your program.
     * Create classes Book and CD, which implement the Interface.
     * Book has a constructor which is given the author (String), name of the book (String),
     * and the weight of the book (double) as parameters.
     ...
     * The classes must work as follows:
     */
     ...
     * Part 2: Box
     *
     * Make a class called Box.
     * Items implementing the Packable interface can be packed into a box.
     ...
     * Part 3: Box weight
     *
     * If you made a class variable double weight in the Box class,
     * replace it with a method which calculates the weight of the box:
     */
    //public class Box {
    //    //...
    //
    ...
    //}
    /*
     * When you need the weight of the box,
     * for example when adding a new item to the box,
     * you can just call the weight method.
     *
     * The method could also return the value of an object variable.
     * However here we are practicing a situation,
     * where we do not have to maintain an object variable explicitly,
     * but can calculate its value as needed.
     * After the next exercise storing the weight as an object variable would not neccessary work anyway.
